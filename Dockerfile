...
RUN mkdir -p /root/scripts/mybackup/ver.1.0/
RUN mkdir /root/bin/
RUN cp -R /sh_tool/bin/   /root/scripts/mybackup/ver.1.0/
RUN cp -R /sh_tool/conf/  /root/scripts/mybackup/ver.1.0/
RUN cp -R /sh_tool/log/   /root/scripts/mybackup/ver.1.0/
RUN rm -Rf /sh_tool/
RUN chmod -R 755 /root/scripts/mybackup/ver.1.0/
RUN ln -s /root/scripts/mybackup/ver.1.0/bin/mybackup.sh /root/bin/mybackup
RUN tree /root/scripts/mybackup/ver.1.0/

...
Copyright
    ...
    mybackup is distributed in the hope that it will be useful, but
...
htmlhelp_basename: str = 'mybackupdoc'
latex_elements: Dict[Any, Any] = {}
latex_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'mybackup.tex', 'mybackup Documentation',
    'Vladimir Roncevic \\textless{}elektron.ronca@gmail.com\\textgreater{}',
    'manual'
)]
man_pages: List[Tuple[Any, ...]] = [(
    master_doc, 'mybackup', 'mybackup Documentation', [author], 1
)]
texinfo_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'mybackup', 'mybackup Documentation', author, 'mybackup',
